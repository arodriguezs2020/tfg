...
public interface HabitacionRepository extends JpaRepository<Habitacion, Integer>{
	@Query(value = "select h from Habitacion h where is not exists (select null from Reserva r where r.habitacion.id = h.id and :entrada <= r.entrada and :salida >= r.salida)")
